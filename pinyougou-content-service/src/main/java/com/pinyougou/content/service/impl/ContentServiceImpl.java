...
public class ContentServiceImpl implements ContentService {
	...
	public PageResult findPage(TbContent content, int pageNum, int pageSize) {
		...
		public List<TbContent> findByCategoryId(Long categoryId) {
			// 加入缓存的代码:
			List<TbContent> list = (List<TbContent>) redisTemplate.boundHashOps("context").get(categoryId);
			...
			if(list==null){
				...
				redisTemplate.boundHashOps("context").put(categoryId, list);
			}else{
				System.out.println("色发射点发");
			}
